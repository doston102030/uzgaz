...
--
-- Region note: seed data covers Andijon shahri + tumanlar (Asaka,
-- Shahrixon, Xo'jaobod, Marhamat) instead of the original Tashkent demo
-- set, to match the app's map/companies focus.
...
-- ── seed: companies (Andijon viloyati) ─────────────────────────────
...
values
  ('c1','Andijon Gaz Ta''minot',4.8,214,2.1,120000,15000,40,'08:00 - 22:00',true,40.7860,72.3480,
   'Andijon shahri, Bobur shoh ko‘chasi 108','+998742251010',array['Sertifikatlangan','Tez yetkazish']),
  ('c2','Asaka Energiya Servis',4.6,158,19.5,118000,20000,70,'09:00 - 21:00',true,40.6414,72.2331,
   'Asaka tumani, Mustaqillik ko‘chasi 24','+998742252020',array['Ommabop']),
  ('c3','Shahrixon Gaz Ta''minot',4.5,97,24.0,115000,22000,80,'24/7',true,40.7275,72.0281,
   'Shahrixon tumani, Navoiy ko‘chasi 12','+998742253030',array['24/7']),
  ('c4','Xo''jaobod Metan Servis',4.7,132,34.0,121000,28000,95,'08:00 - 20:00',false,40.8781,72.6494,
   'Xo‘jaobod tumani, Istiqlol ko‘chasi 45','+998742254040',array[]::text[]),
  ('c5','Marhamat Sanoat Gaz',4.4,76,33.0,117000,26000,90,'08:00 - 23:00',true,40.4497,72.2739,
   'Marhamat tumani, Amir Temur ko‘chasi 7','+998742255050',array[]::text[]),
  ('c6','Andijon GazPlus',4.9,301,3.4,125000,0,35,'24/7',true,40.7790,72.3510,
   'Andijon shahri, Buyuk Ipak Yo‘li 61','+998742256060',array['Yetkazish bepul','24/7'])
...
values
  ('p1','Gaz ballon 50L',
   ...
   120000,135000,4.8,214,true,true,'c1','Andijon Gaz Ta''minot','gazBallon',
  ...
  ('p2','Gaz ballon 25L',
   'https://haurszcvivpqdyenfwbb.supabase.co/storage/v1/object/public/product-images/catalog/gazBallon.jpg',
   76000,null,4.6,143,true,true,'c2','Asaka Energiya Servis','gazBallon',
  ...
  ('p3','Propan ballon 27L',
   ...
   62000,null,4.3,58,true,false,'c3','Shahrixon Gaz Ta''minot','propanGaz',
  ...
  ('p4','Metan gaz (CNG)',
   ...
   45000,null,4.5,89,false,false,'c5','Marhamat Sanoat Gaz','metanGaz',
  ...
  ('p5','Suyultirilgan gaz',
   ...
   133000,149000,4.9,301,true,true,'c6','Andijon GazPlus','suyultirilganGaz',
  ...
  ('p6','Elektr quvvatlash — 60 kVt',
   ...
   1200,null,4.7,126,true,false,'c6','Andijon GazPlus Energy','elektrQuvvatlash',
  ...
  ('p7','Benzin AI-95',
   ...
   12500,null,4.6,412,true,true,'c1','Andijon Gaz Ta''minot','benzin',
   'Yevro-5 standartidagi AI-95 benzini.',
   'litr','{"Oktan soni":"95","Standart":"Yevro-5"}'),
  ('p8','Benzin AI-92',
   'https://haurszcvivpqdyenfwbb.supabase.co/storage/v1/object/public/product-images/catalog/benzin.jpg',
   11200,null,4.4,268,true,false,'c2','Asaka Energiya Servis','benzin',
  ...
  ('p9','Dizel Yevro-5',
   ...
   13800,null,4.5,174,true,false,'c5','Marhamat Sanoat Gaz','dizel',
  ...
  ('p10','Motor moyi 4L',
   ...
   285000,320000,4.7,63,true,false,'c4','Xo''jaobod Metan Servis','market',
   'Sintetik motor moyi 5W-40, 4 litrlik idishda.',
   'dona','{"Hajm":"4 litr","Turi":"5W-40 sintetik"}'),
  ('p11','Gaz reduktori',
   'https://haurszcvivpqdyenfwbb.supabase.co/storage/v1/object/public/product-images/catalog/market.jpg',
   95000,null,4.2,41,true,false,'c3','Shahrixon Gaz Ta''minot','market',
   'Ballon uchun bosim reduktori, manometr bilan.',
   'dona','{"Chiqish bosimi":"30 mbar"}'),
  ('p12','Propan ballon 12L',
   'https://haurszcvivpqdyenfwbb.supabase.co/storage/v1/object/public/product-images/catalog/propanGaz.jpg',
   38000,null,4.1,27,true,false,'c2','Asaka Energiya Servis','propanGaz',
